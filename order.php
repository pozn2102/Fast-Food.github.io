    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="email" name="email" placeholder="Enter @gmail.com" class="input-responsive" required>
        ...
        if (isset($_POST['submit']))
        {
            ...
            if ($res2 == true)
            {
                $_SESSION['order'] = "<div class='succes text-center'>Food Order Successfully.</div>";
                header('location:'.SITEURL);
            }
            else
            {
